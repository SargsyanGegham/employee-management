...
This is a Next.js employee management application with:
...
- Material-UI, Emotion, Tailwind CSS
- Redux Toolkit, Axios
- JSON Server for mock backend

When writing code, always follow the above guidelines and maintain consistency with the existing codebase structure.
